...
const About = () => {
    ...
    return (
        <div className="relative min-h-screen bg-white font-righteous overflow-hidden">
            ...
            {/* Main Content */}
            <div className="relative z-10 px-6 sm:px-10 md:px-16 pt-24">
                <h1 className="text-4xl sm:text-5xl md:text-6xl text-purple-900 mb-4">About Us</h1>
                <p className="text-black font-medium text-base sm:text-md max-w-[750px] leading-7 mb-12">
                ...
                <div className="flex flex-col md:flex-row flex-wrap gap-6 md:gap-8">
                    ...
                    <motion.div
                        ...
                        className="bg-white/30 backdrop-blur-lg rounded-xl shadow-lg p-6 w-full md:w-[380px] text-black border border-white/40"
                        onMouseEnter={() => setHoveredCard('vision')}
                        onMouseLeave={() => setHoveredCard(null)}
                    >
                        <div className="flex items-center mb-2 text-lg sm:text-xl font-bold">
            ...
            {/* Footer */}
            <div className="absolute bottom-6 left-6 sm:left-12 text-xs sm:text-sm text-gray-400 z-10">
                © 2025 HydraX <a href="#" className="underline">Terms</a> <a href="#" className="underline ml-2">Privacy</a>
            </div>

            {/* Social Icons */}
            <div className="absolute bottom-6 right-6 sm:right-12 flex space-x-4 text-purple-400 text-lg z-10">
